// V0/Shadcn-style UI implementation for Rvised Extension
// This is the exact modern Chrome extension UI pattern

function getV0UIHTML(isMinimized, isSummarized, isProcessing, showSettings, activeMode, activeTab, personalNotes) {
  return `
    <div id="rvised-wrapper" class="rvised-extension">
      <style>
        ...
        .rvised-settings-group:last-child {
          margin-bottom: 0;
        }
      ...
      <div class="rvised-card ${isMinimized ? 'minimized' : ''}" id="rvised-card">
        ...
        <div class="rvised-settings" id="settings-panel" style="${showSettings ? '' : 'display: none;'}">
          <div class="rvised-settings-group">
            ...
            <div class="rvised-button-group" id="learning-mode-group">
              ...
              <button data-mode="researcher" class="${activeMode === 'researcher' ? 'active' : ''}">🔬 Researcher</button>
            </div>
          </div>
          
          <div class="rvised-settings-group">
            <div class="rvised-settings-label">Summary Depth</div>
            <div class="rvised-button-group" id="summary-depth-group">
              <button data-depth="quick">⚡ Quick</button>
              <button data-depth="standard" class="active">📝 Standard</button>
              <button data-depth="detailed">📖 Detailed</button>
            </div>
          </div>
        ...
        <!-- Content Area -->
        <div class="rvised-content" id="tab-content" style="${!isSummarized ? 'display: none;' : ''}">
          <!-- Loading State -->
          ...
          <!-- Tab Content -->
          <div id="summary-content" style="${activeTab === 'summary' && isSummarized && !isProcessing ? '' : 'display: none;'}">
            <div id="summary-sections"></div>
          </div>
          
          <div id="keypoints-content" style="${activeTab === 'keypoints' && isSummarized && !isProcessing ? '' : 'display: none;'}">
            <div id="keypoints-sections"></div>
          </div>
          
          <div id="quiz-content" style="${activeTab === 'quiz' && isSummarized && !isProcessing ? '' : 'display: none;'}">
            <div id="quiz-questions"></div>
          </div>
          
          <div id="notes-content" style="${activeTab === 'notes' && isSummarized && !isProcessing ? '' : 'display: none;'}">
