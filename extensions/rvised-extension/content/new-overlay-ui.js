            ...
            ${showProfileDropdown ? `
              <div id="rvised-profile-dropdown" style="position: absolute; top: 40px; right: 16px; background: white; border: 1px solid #e5e7eb; border-radius: 6px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); min-width: 180px; z-index: 10000; font-size: 12px; max-width: calc(100% - 32px);">
                      ...
                      <div style="padding: 4px;">
                        ...
                        ${userTier === 'free' ? `
                          <button id="rvised-upgrade-link" style="width: 100%; text-align: left; padding: 6px 8px; border-radius: 4px; background: linear-gradient(to right, #fbbf24, #f59e0b); border: none; font-size: 11px; color: white; font-weight: 600; cursor: pointer; margin: 2px 0; display: flex; align-items: center; gap: 6px;" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
